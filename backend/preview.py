...
county_counts = pd.merge(county_counts, fips_to_county, on='county', how='right')
print(county_counts)
county_counts.drop("lng", axis=1).drop("lat", axis=1).to_csv('county_counts2.csv', index=False)
